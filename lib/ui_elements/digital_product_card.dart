...
class DigitalProductCard extends StatefulWidget { 
  ...
  DigitalProductCard({Key? key,required this.id, required this.image, required this.name, required this.main_price,required this.stroked_price,required this.has_discount,required this.discount }) : super(key: key);

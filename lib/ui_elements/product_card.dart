...
class ProductCard extends StatefulWidget { 
  ...
  ProductCard({Key? key,required this.id, required this.image, required this.name, required this.main_price,  this.stroked_price,required this.has_discount, this.discount }) : super(key: key);

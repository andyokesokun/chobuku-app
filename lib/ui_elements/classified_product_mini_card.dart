...
class ClassifiedMiniProductCard extends StatefulWidget { 
  ...
  ClassifiedMiniProductCard({Key? key,required this.id, required this.image, required this.name,required this.unit_price,required this.condition }) : super(key: key);

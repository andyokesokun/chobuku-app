...
class PaymentStatus { 
  ...
  static List<PaymentStatus> getPaymentStatusList() {
    return <PaymentStatus>[
      PaymentStatus('', AppLocalizations.of(NavigationService.navigatorKey.currentContext!)!.order_list_screen_all_payments),
      PaymentStatus('paid', AppLocalizations.of(NavigationService.navigatorKey.currentContext!)!.order_list_screen_paid),
      PaymentStatus('unpaid', AppLocalizations.of(NavigationService.navigatorKey.currentContext!)!.order_list_screen_unpaid),
    ];
   }
}
...
class DeliveryStatus { 
  ...
  static List<DeliveryStatus> getDeliveryStatusList() {
    return <DeliveryStatus>[
      DeliveryStatus('', AppLocalizations.of(NavigationService.navigatorKey.currentContext!)!.order_list_screen_all_deliveries),
      DeliveryStatus('confirmed', AppLocalizations.of(NavigationService.navigatorKey.currentContext!)!.order_list_screen_confirmed),
      DeliveryStatus('on_delivery', AppLocalizations.of(NavigationService.navigatorKey.currentContext!)!.order_list_screen_on_delivery),
      DeliveryStatus('delivered', AppLocalizations.of(NavigationService.navigatorKey.currentContext!)!.order_list_screen_delivered),
    ];
   }
}

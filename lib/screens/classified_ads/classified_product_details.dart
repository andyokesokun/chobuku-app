...
class ClassifiedAdsDetails extends StatefulWidget {
  ...
  ClassifiedAdsDetails({Key? key, required this.id}) : super(key: key);
...
class _ClassifiedAdsDetailsState extends State<ClassifiedAdsDetails>
  ...
  ClassifiedAdsData? _productDetails;
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        style: TextButton.styleFrom(
                            minimumSize: const Size(
                                75, 26), // replaces minWidth & height
                            backgroundColor: const Color.fromRGBO(
                                253, 253, 253, 1), // replaces color
                      ...
                      Padding(
                        ...
                        child: TextButton(
                          style: TextButton.styleFrom(
                          minimumSize: const Size(75, 26), // replaces minWidth & height
                  ...
                  children: [
                    Padding(
                      ...
                      child: TextButton(
                        ...
                        style: TextButton.styleFrom(
                          minimumSize: const Size(75, 30), // replaces minWidth & height
                          backgroundColor:Color.fromRGBO(253, 253, 253, 1),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(8.0),
                            side: const BorderSide(color: Color.fromRGBO(107, 115, 119, 1), width: 1.0),
                          ),
                          ),
                        child: Text(
                          "CLOSE",

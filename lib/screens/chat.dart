                  ...
                  SliverList(
                    delegate: SliverChildListDelegate([
                      TextButton(
                        ...
                        style: TextButton.styleFrom(minimumSize: Size(88, 36)),
                        style: TextButton.styleFrom(backgroundColor: color: MyTheme.accent_color,),
                        style: TextButton.styleFrom(shape: shape: RoundedRectangleBorder(
 ...
 AppBar buildAppBar2(BuildContext context) {
  return AppBar(
    ...
    leading: Padding(
      ...
      foregroundColor: Colors.transparent, // text/icon color if needed
    ),
        onPressed: () {
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: Color.fromRGBO(112, 112, 112, .3), width: 1),
                //style: TextButton.styleFrom(shape: shape: BoxShape.rectangle,),
              ),
              child: Center(
                child: Icon(
                  Icons.send,

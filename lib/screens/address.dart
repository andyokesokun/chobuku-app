...
class _AddressState extends State<Address> { 
  ...
  onSelectStateDuringAdd(state, setModalState) { 
    if (state.id == _selected_state!.id) {
      setModalState(() {
  ...
  onSelectStateDuringUpdate(index, state, setModalState) { 
    if (state.id == _selected_state_list_for_update[index].id) {
      setModalState(() {
  ...
  onSelectCityDuringUpdate(index, city, setModalState) { 
    if (city.id == _selected_city_list_for_update[index].id) {
      setModalState(() {
                      ...
                      child: Container(
                        ...
                        child: TextField(
                          ...
                          decoration: buildAddressInputDecoration(
                              context, AppLocalizations.of(context)!.address_screen_enter_address),
                        ),
                      ),
                    ),
                        ...
                        child: TypeAheadField<Country>(
                          ...
                          builder: (context, TextEditingController controller, FocusNode focusNode) {
                            return TextField(
                              ...
                              decoration: buildAddressInputDecoration(
                                context,
                                AppLocalizations.of(context)!.address_screen_enter_country,
                              ),
                            );
                          },
                        ),
                        ...
                        child: TypeAheadField<MyState>(
                          ...
                          builder: (context, TextEditingController controller, FocusNode focusNode) {
                            return TextField(
                              ...
                              decoration: buildAddressInputDecoration(
                                context,
                                AppLocalizations.of(context)!.address_screen_enter_state,
                              ),
                            );
                          },
                        ),
                        ...
                        child: TypeAheadField<City>(
                          ...
                          builder: (context, TextEditingController controller, FocusNode focusNode) {
                            return TextField(
                              ...
                              decoration: buildAddressInputDecoration(
                                context,
                                AppLocalizations.of(context)!.address_screen_enter_city,
                              ),
                            );
                          },
                        ),
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: TextField(
                          ...
                          decoration: buildAddressInputDecoration(
                            context,
                            AppLocalizations.of(context)!.address_screen_enter_postal_code,
                          ),
                        ),
                      ),
                    ),
  ...
  Future buildShowUpdateFormDialog(BuildContext context, int index) {
  return showDialog(
    context: context,
    builder: (context) {
      return StatefulBuilder(
                        ...
                        child: TypeAheadField<Country>(
                          ...
                          builder: (context, TextEditingController controller, FocusNode focusNode) {
                            return TextField(
                              ...
                              focusNode: focusNode,
                              decoration: buildAddressInputDecoration(
                                  context, AppLocalizations.of(context)!.address_screen_enter_country),
                            );
                          },
                        ),
                      ),
                        ...
                        child: TypeAheadField<MyState>(
                          ...
                          builder: (context, TextEditingController controller, FocusNode focusNode) {
                            return TextField(
                              ...
                              focusNode: focusNode,
                              decoration: buildAddressInputDecoration(
                                  context, AppLocalizations.of(context)!.address_screen_enter_state),
                            );
                          },
                        ),
                      ),
                        ...
                        child: TypeAheadField<City>(
                          ...
                          builder: (context, TextEditingController controller, FocusNode focusNode) {
                            return TextField(
                              ...
                              focusNode: focusNode,
                              decoration: buildAddressInputDecoration(
                                  context, AppLocalizations.of(context)!.address_screen_enter_city),
                            );
                          },
                        ),
                      ),
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: TextField(
                          ...
                          decoration: buildAddressInputDecoration(
                              context, AppLocalizations.of(context)!.address_screen_enter_postal_code),
                        ),
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: TextField(
                          ...
                          decoration: buildAddressInputDecoration(
                              context, AppLocalizations.of(context)!.address_screen_enter_phone),
                        ),
                      ),
                    ),
                  ],
...
Widget buildBottomAppBar(BuildContext context) {
  ...
  Widget showOptions({  required listIndex, productId }) { 
    return Container(
      width: 45,

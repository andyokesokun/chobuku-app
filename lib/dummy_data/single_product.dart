class SingleProduct { 
  ...
  SingleProduct(
      ...
      required this.has_disocunt,
      this.price_range,
      required this.rating,
      required this.rating_count,
      required this.in_user_wishlist,
      required this.club_point,
      required this.seller,
      required this.is_inhouse_product,required this.description });
}
...
class Seller { 
  ...
  Seller({required this.shop_name, required this.shop_image });
}

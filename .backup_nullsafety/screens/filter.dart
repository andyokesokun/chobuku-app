...
class WhichFilter {
  ...
  static List<WhichFilter> getWhichFilterList() {
    return <WhichFilter>[
      WhichFilter('product', AppLocalizations.of(NavigationService.navigatorKey.currentContext!).filter_screen_product),
      WhichFilter('sellers', AppLocalizations.of(NavigationService.navigatorKey.currentContext!).filter_screen_sellers),
      WhichFilter('brands', AppLocalizations.of(NavigationService.navigatorKey.currentContext!).filter_screen_brands),
    ];
  }
}
